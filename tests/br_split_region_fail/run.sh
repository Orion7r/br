...
GO_FAILPOINTS="github.com/Orion7r/br/pkg/restore/not-leader-error=1*return(true)->1*return(false);\
github.com/Orion7r/br/pkg/restore/somewhat-retryable-error=3*return(true)" \
